...
The edge weights of the factor score network was highly correlated (*r* = `r round(cor_edgeweight, digits = 3)`) with that of the "main" network, indicating that both networks were highly similar. For this reason, we decided to retain our use of sum scores for the core vulnerability and the DOCS subscales in our network analysis.
