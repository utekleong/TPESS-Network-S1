...
group_subscale_57 <- list("GAD-7" = def_legend(networkdata_allitems_sg,"gad"),
...
# defining grouping for legend
group_subscale <- list("GAD-7" = def_legend(networkdata_us,"gad"),
...
tpess_factorscores <- read_sav("../data/appendix/fsnetwork/fscores.sav") %>% 
  select(1)
...
# defining grouping for legend
group_subscale <- list("GAD-7" = def_legend(networkdata_sg_fs,"gad"),
...
```{r}
# weight matrices
weightmatrix_main <- as.matrix(read.csv("../data/appendix/fsnetwork/weightmatrix.csv"))
